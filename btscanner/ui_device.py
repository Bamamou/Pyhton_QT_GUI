...
class Ui_DeviceDiscovery(object):
    def setupUi(self, DeviceDiscovery):
        ...
        DeviceDiscovery.setWindowIcon(QIcon('C:/Users/admin/Documents/GitHub/GUI/Pyhton_QT_GUI/btscanner/Bluetooth-icon.png'))
        DeviceDiscovery.setStyleSheet("background-color: rgb(245, 245, 240);")
